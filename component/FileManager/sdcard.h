...
#define ESP_ERR_SD_INIT_FAILED          ((ID_SD_CARD << 12)|(0x00))
#define ESP_ERR_SD_OPEN_FILE_FAILED     ((ID_SD_CARD << 12)|(0x01))
#define ESP_ERR_SD_WRITE_DATA_FAILED    ((ID_SD_CARD << 12)|(0x02))
#define ESP_ERR_SD_READ_DATA_FAILED     ((ID_SD_CARD << 12)|(0x03))

#define SPI_BUS_CONFIG_DEFAULT()  { .mosi_io_num = PIN_NUM_MOSI,    \
 ...
 * @retval  - ESP_OK on success.
 * @retval  - ESP_FAIL on fail.
 * @retval  - ESP_ERR_SD_OPEN_FILE_FAILED on can't open file.
 * @retval  - ESP_ERR_SD_WRITE_DATA_FAILED on fail to write data.
 */
 ...
 * @retval  - ESP_FAIL on fail.
 * @retval  - ESP_ERR_SD_OPEN_FILE_FAILED on can't open file.
 * @retval  - ESP_ERR_SD_READ_DATA_FAILED on fail to read data.
 */
